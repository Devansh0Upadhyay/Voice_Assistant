...
def engine_speak(audio_string):
    ...
    print(alexis_obj.name + ":", audio_string) # print what app said
...
def respond(voice_data):
    ...
    if there_exists(["what is your name","what's your name","tell me your name"]):
        ...
        if person_obj.name:
            engine_speak(f"My name is {alexis_obj.name}, {person_obj.name}") #gets users name from voice input
        else:
            engine_speak(f"My name is {alexis_obj.name}. what's your name?") #incase you haven't provided your name.
    ...
    if there_exists(["your name should be"]):
        ...
        engine_speak("okay, i will remember that my name is " + alexis_name)
        alexis_obj.setName(alexis_name) # remember name in alexis object
    ...
    if there_exists(["capture","my screen","screenshot"]):
        ...
        myScreenshot.save('C:/Users/Mayank/Desktop/Alexis_Speech_Assistant/screen.png')
    ...
    if there_exists(["exit", "quit", "goodbye"]):
        engine_speak("bye","see you later","get back to you")
        exit()
